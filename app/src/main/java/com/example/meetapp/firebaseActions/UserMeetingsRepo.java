...
public class UserMeetingsRepo {
    ...
    private final MutableLiveData<ArrayList<LiveData<Meeting>>> meetingsListMutableLiveData = new MutableLiveData<>();
    private final ArrayList<LiveData<Meeting>> userAllMeetingsList = new ArrayList<>();
                                ...
                                .addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        if (snapshot.exists()) {
                                            ...
                                            long todayMillis = Calendar.getInstance().getTime().getTime();
                                            if (meeting != null && meeting.getMillis() > todayMillis - 7200000) {
    ...
    public HashMap<String, String> getMeetingIdToStringDate() {
        return meetingIdToStringDate;
    }

    public LiveData<ArrayList<LiveData<Meeting>>> getMeetingsListMutableLiveData() {
